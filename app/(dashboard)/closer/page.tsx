        ...
        {upcoming.length === 0 ? (
          ...
          <ul className="space-y-2">
            {upcoming.map((call) => (
              <li
                key={call.id}
                className="flex items-start gap-3 rounded-[10px] border border-[color:var(--border-rgba)] bg-[var(--surface-elevated)] p-3"
              >
  ...
  const toneClass =
    tone === "success"
      ...
      : tone === "destructive"
        ...
        : "text-foreground";
  return (
    <div className="rounded-[12px] border border-[color:var(--border-rgba)] bg-[var(--surface-elevated)] p-4">
