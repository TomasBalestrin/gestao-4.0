...
export default async function FinanceiroFunilPage({ params }: PageProps) {
  ...
  const { data: funil } = await supabase
    .from("funis")
    .select("id, nome, role_alvo, etapas!funil_id(id, nome, cor, ordem)")
    .eq("id", params.funilId)
    .maybeSingle();
  if (!funil || funil.role_alvo !== "financeiro") notFound();
