...
function ScopeOption({
  ...
  return (
    <button
      ...
      aria-pressed={active}
      className={cn(
        "flex flex-col items-start gap-1 rounded-md border bg-card p-3 text-left text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
        active
