...
Docs do projeto: `architecture.md`, `tech-stack.md`, `schema.md`, `security.md`, `PRD.md`, `ux-flows.md`, [`docs/NAVY_DS.md`](docs/NAVY_DS.md).
...
- **Tailwind only.** Dark mode via `class` (next-themes); paleta **Navy DS** (navy + glassmorphism, ver `docs/NAVY_DS.md`).
